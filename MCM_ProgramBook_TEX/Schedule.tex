...
\OpeningClosingEvent{08:45--09:00}{Opening Ceremony by Fred Hickernell, HH Auditorium}\\
\input{sessP1.tex}
...
{\textbf{Technical Session}\par Quasi-Monte Carlo, Part 1}
{Peter Kritzer}
&\tableContributedCL{HH Alumni Lounge}
...
{Sou-Cheng Choi}
&\tableContributedCL{HH Alumni Lounge}
{\textbf{Technical Session}\par Quasi-Monte Carlo, Part 2}
{Christian Weiss}
\\\hline
...
{T11-4}
\\\hline
\TableEvent{18:30--20:30}{Steering Committee Meeting (by invitation), Victory Tap, 1416 S Michigan Avenue}\\
