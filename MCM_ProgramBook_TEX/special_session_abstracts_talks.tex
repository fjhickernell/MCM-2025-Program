...
\begin{talk}
  ...
  {T. K. Rusch, D. Rus, J. Zech, F. Cl\'ement, D. Chen, C. Doerr, L. Paquette}% [5] coauthors
...
\begin{talk}
  {TALK WITHDRAWN---Boosting the inference for generative models by (Quasi-)Monte Carlo resampling}% [1] talk title
...
\begin{talk}
  ...
  {pasupath@purdue.edu}% [5] coauthors
  {Raghu Pasupathy, S. G. Henderson}% [6] special session
  {Tue, Jul 29 17:00--17:30}% [7] time slot
  {S15-4}% [8] talk id
  {S15}% [9] session id or photo
