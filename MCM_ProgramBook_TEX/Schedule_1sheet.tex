...
\cellcolor{\SessionTitleColor} & \cellcolor{\SessionTitleColor}(HH Lobby) \\
\hline
\end{tabularx}
}
\end{table}
...
\cellcolor{\EmptyColor}19:00--late & \cellcolor{\EmptyColor}Early Career Dinner (Time Out Market, 916 W Fulton Market) \\
\hline
\end{tabularx}
}
\end{table}
