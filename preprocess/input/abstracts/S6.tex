...
\begin{session}
  ...
  {\organizer{Philipp A. Guth}% organizer one name
    {RICAM, Austrian Academy of Sciences}% organizer one affiliations
    {philipp.guth@ricam.oeaw.ac.at}}% organizer one email
  {\organizer{Vesa Kaarnioja}% organizer two name
    {Free University of Berlin}% organizer two affiliations
