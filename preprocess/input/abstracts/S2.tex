...
\begin{session}
  ...
  {\organizer{Andr\'e-Alexander Zepernick}% organizer one name
    {Free University of Berlin}% orgnizer one affiliations
    {a.zepernick@fu-berlin.de}}% organizer one email
  {\organizer{Philipp A. Guth}% organizer two name, if needed
	{RICAM, Austrian Academy of Sciences}% orgnizer two affiliations, if needed
	{philipp.guth@ricam.oeaw.ac.at}}% organizer two email
  {\organizer{Vesa Kaarnioja}% organizer one name
	{Free University of Berlin}% orgnizer one affiliations
	{vesa.kaarnioja@fu-berlin.de}}% organizer one email
