...
\centering 
\includegraphics[width=\textwidth]{reeds_flux_comparison.png} % User needs to create this image 
\caption{Scalar flux comparison} 
\end{subfigure} 
\hfill 
\begin{subfigure}[b]{0.48\textwidth} 
\centering 
\includegraphics[width=\textwidth]{reeds_flux_absolute_error.png} % User needs to create this image 
\caption{Absolute error vs. analytic} 
\end{subfigure} 
\caption{Results for the Reed's problem benchmark demonstrating Monte Carlo convergence. (a) The new method scalar flux (orange) shows agreement with the analytic solution (black) and reference MC simulation. (b) The absolute error exhibits the characteristic stochastic fluctuations of Monte Carlo methods, with magnitude comparable to traditional MC.} 
\label{fig:reeds_problem} 
\end{figure}
