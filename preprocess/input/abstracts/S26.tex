...
\begin{session}
  ...
  % Theory of Gradient-Based Samplers
  % Analysis of Langevin and related sampling algorithms
  % Analysis of Gradient-Based Samplers %(to emphasize that we include numerical analysis of proposed algorithms?)
  % Theory and Algorithms of Gradient-Based Samplers
  %[1] session title
