...
concentrates on numerical experiments demonstrating theoretical error estimates.
...
We illustrate this setting through several examples, and numerical results complement theory.
...
\begin{talk}
  ...
  {}% [5] coauthors
  {}% [6] special session
  {Wed, July 30 10:30–12:30 Track C}% [7] time slot
  {S18-1}% [8] talk id
