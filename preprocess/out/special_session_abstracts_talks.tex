...
\begin{talk}
  ...
  {Andr\'{e} Gustavo Carlon, Luis Espath, Sebastian Krumscheid, Ra\'ul Tempone}% [5] coauthors
  {}% [6] special session
  {Mon, Jul 28 17:00---17:30}% [7] time slot
  {S6-4}% [8] talk id
  {S6}% [9] session id or photo
...
\begin{talk}
  ...
  {Chiheb Ben Hammouda, Sophia M\"{u}nker, Ra\'ul Tempone}% [5] coauthors
  {Forward and Inverse Problems for Stochastic Reaction Networks}% [6] special session
