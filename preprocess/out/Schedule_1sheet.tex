...
\cellcolor{\PlenaryColor}08:45--09:00 & \cellcolor{\PlenaryColor}Opening Ceremony (HH Auditorium) \\
...
\cellcolor{\SessionLightColor}15:30--17:30 & \cellcolor{\SessionLightColor}Technical Session - PDEs and SDEs (HH Alumni Lounge) \\
...
\cellcolor{\SessionTitleColor}18:30--20:30 & \cellcolor{\SessionTitleColor}Steering Committee Meeting (by invitation) (Victory Tap, 1416 S Michigan Avenue) \\
\hline
\end{tabularx}
}
\end{table}
...
\cellcolor{\PlenaryColor}12:30--12:40 & \cellcolor{\PlenaryColor}Closing Ceremony (HH Auditorium) \\
\hline
\end{tabularx}
}
\end{table}
