...
\begin{session}
 ...
 {S1}% [8] session id
 {Larisa Yaroslavtseva}% [9] organizer three name, if any
...
\begin{session}
 ...
 {S2}% [8] session id
 {Vesa Kaarnioja}% [9] organizer three name, if any
...
\begin{session}
 ...
 {S4}% [8] session id
 {Mike Giles}% [9] organizer three name, if any
...
\begin{session}
 ...
 {S9}% [8] session id
 {Youssef Marzouk}% [9] organizer three name, if any
...
\begin{session}
 ...
 {S10}% [8] session id
 {}% [9] organizer three name, if any

 {Alex Shestopaloff}% [2] organizer name
 {Queen Mary University of London, UK}% [3] affiliations
 {a.shestopaloff@qmul.ac.uk}% [4] email
 {Jun Yang}% [5] second organizer name. Leave unchanged if there is no second organizer, otherwise fill in accordingly.
...
\begin{session}
 ...
 {S14}% [8] session id
 {Ra\'ul Tempone}% [9] organizer three name, if any
...
\begin{session}
 {HAdvances in Adaptive Hamiltonian Monte Carlo}% [1] session title
...
\begin{session}
 ...
 {S22}% [8] session id
 {Peter Kritzer}% [9] organizer three name, if any
...
\begin{session}
 ...
 {S23}% [8] session id
 {Jonathan Weare}% [9] organizer three name, if any
...
\begin{session}
 ...
 {S28}% [8] session id
 {Raúl Tempone}% [9] organizer three name, if any
