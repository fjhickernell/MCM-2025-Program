...
{Technical Session 1 - Markov Chain Monte Carlo}
{TBD}
\\\hline
...
{Technical Session 4 - Quasi-Monte Carlo, Part 1}
{TBD}
&\tableContributedCL{HH Alumni Lounge}
{Technical Session 12 - PDEs}
{TBD}
\\\hline
...
{T12-4}
\\\hline
\TableEvent{17:30--19:30}{Welcome Reception}\\
...
{TBD}
&\tableContributedCL{HH Alumni Lounge}
{Technical Session 2 - Bayesian Methods}
{TBD}
\\\hline
...
{TBD}
&\tableContributedCL{HH Alumni Lounge}
{Technical Session 5 - Quasi-Monte Carlo, Part 2}
{TBD}
\\\hline
...
{TBD}
&\tableContributedCL{WH Auditorium}
{Technical Session 15 - Simulation}
{TBD}
&\tableContributedCL{HH Alumni Lounge}
{Technical Session 6 - Sampling}
{TBD}
\\\hline
...
{TBD}
&\tableContributedCL{WH Auditorium}
{Technical Session 16 - Statistics}
{TBD}
&\tableContributedCL{HH Alumni Lounge}
{Technical Session 10 - Langevin}
{TBD}
\\\hline
...
&
\\\hline
\TableEvent{16:00--16:30}{Coffee Break}\\
\TableEvent{18:00--20:30}{Conference Dinner}\\
...
{TBD}
&\tableContributedCL{WH Auditorium}
{Technical Session 8 - Finance}
{TBD}
&\tableContributedCL{HH Alumni Lounge}
{Technical Session 13 - ML \& Optimization}
{TBD}
\\\hline
...
{TBD}
&\tableContributedCL{WH Auditorium}
{Technical Session 7 - Sampling}
{TBD}
&\tableContributedCL{HH Alumni Lounge}
{Technical Session 11 - SDEs}
{TBD}
\\\hline
...
&
\\\hline
\TableEvent{18:00--20:30}{Steering Committee Meeting (by invitation)}\\
...
{Technical Session 3 - Simulation}
{TBD}
&\tableContributedCL{WH Auditorium}
{Technical Session 9 - Sampling}
{TBD}
&\tableContributedCL{HH Alumni Lounge}
{Technical Session 14 - Markov Chain Monte Carlo}
{TBD}
\\\hline
...
\input{sessP8.tex}
\hline
\OpeningClosingEvent{12:00--12:15}{Closing Remarks by TBD, HH Auditorium}\\
