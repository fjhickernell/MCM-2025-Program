...
def generate_schedule_latex(df: pd.DataFrame, outdir: str) -> str:
    ...
    # Replace "Technical Session - " with "\textbf{Technical Session}\par"
    latex_content = re.sub(r'Technical Session - ', r'\\textbf{Technical Session}\\par ', latex_content, flags=re.IGNORECASE)
    # clean text
